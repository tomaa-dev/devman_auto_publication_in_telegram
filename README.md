...
**PUBLISH_INTERVAL** - время в секундах между публикациями изображений. Указывает, как долго программа будет ждать перед тем, как отправить следующее изображение.